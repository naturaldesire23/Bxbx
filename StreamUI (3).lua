...
local LOGO_ICON = "rbxassetid://14488650713"
...
function StreamUI:CreateWindow(title)
    ...
    -- Slow, endless white -> grey -> white color cycle on the badge icon
    do
        local cycle = TweenService:Create(
            LogoImage,
    ...
    MiniBadgeButton.MouseButton1Click:Connect(function()
