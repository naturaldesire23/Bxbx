...
local THEME_NAMES = { "Vanilla", "Midnight", "Ocean", "Forest", "Monochrome" }
...
function StreamUI:CreateWindow(title)
    ...
    -- shows through empty space and never covers a control.
    local function placeFlower(x, y, size)
        local Flower, petals, center = createFlower(Main, size, Theme.Enabled, Theme.Border)
        Flower.Position = UDim2.fromOffset(x, y)
        Flower.ZIndex = 0
    ...
    placeFlower(360, 245, 8)
    placeFlower(390, 262, 6)
    placeFlower(150, 250, 6)
